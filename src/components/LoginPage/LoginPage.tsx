...
const LoginPage = ({ onSuccess }: Props) => {
  ...
  return (
    <>
      ...
      <div className="relative z-10 flex flex-col items-center gap-4 pt-18 md:pt-0">
        {/* THE NEW LOGO */}
        <img
          src="/logo-myindex.png"
          alt="MyIndex logo"
          className="h-auto object-contain w-md transition-transform duration-300 hover:scale-105 "
        />
        ...
        <p className="text-center text-xs text-background max-w-sm px-4">
